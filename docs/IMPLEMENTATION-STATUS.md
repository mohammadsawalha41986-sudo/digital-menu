...
| **Undo / redo** | **DONE** | Last 20 theme/layout decisions in the active editor; undo and redo autosave the draft, while published version rollback remains authoritative |
